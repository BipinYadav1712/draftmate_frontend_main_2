  ...
  return (
    <div className="bg-slate-50 dark:bg-[#101622] text-[#111318] font-sans overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 flex items-center whitespace-nowrap border-b border-solid border-b-[#f0f2f4] bg-white/95 backdrop-blur-sm px-6 py-3 lg:px-10">
        ...
        <Link
          to="/"
          className="flex items-center gap-4 text-[#111318] flex-shrink-0"
        >
        ...
        {/* Mobile Hamburger */}
        <button
          className="lg:hidden p-2 ml-auto hover:bg-slate-100 rounded-lg transition-colors"
            ...
            <div className="p-6">
              ...
              <nav className="flex flex-col gap-4">
                ...
                <a
                  ...
                  className="flex items-center gap-3 p-3 text-[#111318] font-medium hover:bg-primary/5 hover:text-primary rounded-lg transition-colors cursor-pointer"
                >
      ...
      <section className="relative flex flex-col items-center justify-center py-16 lg:py-24 px-4 bg-white overflow-hidden">
        ...
        <div className="layout-content-container flex flex-col max-w-[960px] w-full gap-12 z-10">
          <div className="flex flex-col gap-6 text-center items-center">
            {/* Badge */}
            <div
              className="inline-flex items-center gap-2 rounded-full border-2 border-primary bg-blue-50/80 px-4 py-1.5 text-xs font-bold text-primary uppercase tracking-widest cursor-pointer
             animate-[badgeSlideIn_0.6s_cubic-bezier(0.34,1.56,0.64,1)_both]
             hover:scale-105 hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(37,99,235,0.2)]
                transition-all duration-200"
              style={{
                animation:
                  "badgeSlideIn 0.6s cubic-bezier(0.34,1.56,0.64,1) both, badgePulse 2.5s ease-in-out 3s infinite",
              }}
            >
            ...
            <h1 className="text-[#111318] text-4xl lg:text-6xl font-black leading-tight tracking-[-0.033em] max-w-[800px] text-center">
              {[
                { text: "Draft", blue: false, delay: "0.3s" },
                { text: "Court-Ready", blue: false, delay: "0.39s" },
                { text: "Legal", blue: false, delay: "0.48s" },
                { text: "Documents", blue: false, delay: "0.57s" },
                { text: "in", blue: false, delay: "0.66s" },
                { text: "Minutes", blue: true, delay: "0.75s" },
                { text: "with", blue: true, delay: "0.84s" },
                { text: "AI", blue: true, delay: "0.93s" },
              ].map((word, i) => (
                <span
                  key={i}
                ...
                ${
                  word.blue
                    ...
                    : "text-[#111318] hover:text-primary"
                }`}
                  style={{
                    opacity: 1,
                    animation: `wordFadeUp 0.5s ease ${word.delay} forwards`,
                    marginRight: "0.22em",
                  }}
                >
                  {word.text}
            ...
            <h2 className="text-[#616f89] text-lg font-normal leading-relaxed lg:text-xl max-w-[700px]">
              India’s Smart Legal Drafting & Research Assistant for Advocates.
              Save hours on research and formatting with verified citations.
            </h2>
            <div className="flex flex-wrap gap-3 justify-center pt-4">
              <Link
                to="/login"
                className="flex min-w-[140px] items-center justify-center rounded-lg h-12 px-6 
              ...
              {/* Book a Demo Button */}
              <button
                className="group flex min-w-[152px] cursor-pointer items-center justify-center gap-1 overflow-hidden rounded-xl h-13 px-7 bg-white border-[1.5px] border-[#d1d5db] text-[#111318] text-base font-bold leading-normal tracking-[0.015em]
        hover:border-primary hover:text-primary hover:bg-blue-50 hover:-translate-y-0.5 hover:scale-[1.02] hover:shadow-[0_6px_18px_rgba(37,99,235,0.12)]
        active:scale-[0.97] transition-all duration-200"
                style={{
                  animation:
                    "btnPop 0.6s cubic-bezier(0.34,1.56,0.64,1) 1.75s both",
                  opacity: 1,
                }}
              >
                Book a Demo
          ...
          <div className="relative w-full aspect-[16/9] lg:aspect-[2/1] rounded-xl overflow-hidden shadow-2xl border border-[#f0f2f4] bg-white group">
            ...
            <div className="w-full h-full bg-[#f8faff] flex flex-col">
              <div className="h-10 border-b flex items-center px-4 gap-2 bg-white">
                ...
                <div className="ml-4 h-6 w-64 bg-slate-100 rounded text-xs flex items-center px-2 text-slate-400">
                  draftmate.in/editor/
                </div>
              </div>
      ...
      <section className="bg-white pb-12 pt-6 px-4 lg:px-40">
        <div className="flex flex-col items-center gap-8 max-w-[960px] mx-auto">
          <h3 className="text-[#616f89] text-xl font-serif text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 w-full opacity-70">
            ...
            <div className="h-8 md:h-10 grayscale hover:grayscale-0 transition-all duration-300 cursor-pointer flex items-center gap-2">
              <img
                src={Karnataka_News_NetworkLogo}
                alt="Karnataka News Network"
                className="h-full object-contain"
              />
            </div>
            <div className="h-8 md:h-10 grayscale hover:grayscale-0 transition-all duration-300 cursor-pointer flex items-center gap-2">
              <img
                src={India_Wire_NewsLogo}
                alt="India Wire News"
                className="h-full object-contain"
              />
            </div>
      ...
      <section className="border-y border-[#f0f2f4] bg-white py-12">
        <div className="flex flex-col items-center gap-8 px-4 lg:px-40">
          <h3 className="text-[#616f89] text-sm font-bold uppercase tracking-wider">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-[960px]">
            <div className="flex items-start gap-4 p-4 rounded-xl hover:bg-[#f8faff] transition-colors">
              ...
              <div>
                <h4 className="text-[#111318] text-lg font-bold">
                  Indian Context
                </h4>
                <p className="text-[#616f89] text-sm mt-1">
                  Trained on IPC, CRPC, CPC & Indian Constitution.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-xl hover:bg-[#f8faff] transition-colors">
              ...
              <div>
                ...
                <p className="text-[#616f89] text-sm mt-1">
                  Real-time links to Supreme Court & High Court judgments.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-xl hover:bg-[#f8faff] transition-colors">
              ...
              <div>
                ...
                <p className="text-[#616f89] text-sm mt-1">
                  Strict guardrails ensure no fake cases are invented.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 lg:px-40 bg-slate-50 dark:bg-[#101622]">
        <div className="layout-content-container flex flex-col max-w-[960px] mx-auto gap-12">
          <div className="flex flex-col gap-4 text-center">
            <h2 className="text-[#111318] text-3xl font-black leading-tight lg:text-4xl">
              Everything you need to modernize your practice
            </h2>
            <p className="text-[#616f89] text-lg max-w-[600px] mx-auto">
              From research to filing, DraftMate acts as your intelligent
              digital junior.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: "edit_document",
                title: "Smart AI Legal Drafting",
                desc: "Generate petitions, agreements, and notices in seconds tailored to your specific case facts.",
              },
              {
                icon: "library_books",
                title: "Lex Bot Research",
                desc: "Your personal research assistant. Ask complex legal queries and get precise answers with sources.",
              },
              {
                icon: "gavel",
                title: "Authentic Case Laws",
                desc: "Access a massive database of judgments. Only verified citations, ensuring total reliability.",
              },
              {
                icon: "picture_as_pdf",
                title: "Chat with PDF",
                desc: "Upload bulky case files or judgments and chat with them to extract summaries and key points instantly.",
              },
              {
                icon: "style",
                title: "Personalized Style",
                desc: "The AI learns your drafting tone and vocabulary over time, making every document sound like you wrote it.",
              },
              {
                icon: "calculate",
                title: "Legal Calculators",
                desc: "Built-in tools for Court Fees, Limitation periods, and Interest calculations based on Indian acts.",
              },
            ].map((feature, idx) => (
              <div
                key={idx}
                className="group flex flex-col gap-4 p-6 rounded-xl bg-white border border-[#f0f2f4] hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
              >
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-[#111318] text-xl font-bold">
                    {feature.title}
                  </h3>
      ...
      <section className="py-20 px-4 lg:px-40 bg-white border-y border-[#f0f2f4]">
        <div className="layout-content-container flex flex-col max-w-[960px] mx-auto gap-12">
          <div className="flex flex-col gap-4 text-center">
            <h2 className="text-[#111318] text-3xl font-black leading-tight lg:text-4xl">
              Why DraftMate is Better than Generic AI
            </h2>
            <p className="text-[#616f89] text-lg max-w-[600px] mx-auto">
          ...
          <div className="overflow-x-auto rounded-2xl border border-[#f0f2f4] shadow-sm">
            <table className="w-full text-left bg-white">
              <thead className="bg-[#f8faff] border-b border-[#f0f2f4]">
                <tr>
                  <th className="py-5 px-6 text-sm font-bold text-[#616f89] uppercase tracking-wider w-1/3">
                    Feature
                  </th>
                  <th className="py-5 px-6 text-lg font-bold text-[#111318] w-1/3">
                    Generic AI (ChatGPT)
                  </th>
              ...
              <tbody className="divide-y divide-[#f0f2f4]">
                {[
                  {
                    feature: "Indian Case Law Knowledge",
                    generic: "Limited, often outdated",
                    draftmate: "Real-time & Verified",
                  },
                  {
                    feature: "Citation Accuracy",
                    generic: "High risk of hallucinations",
                    draftmate: "100% Verified Sources",
                  },
                  {
                    feature: "Document Formatting",
                    generic: "Plain text, needs reformatting",
                    draftmate: "Court-Ready Templates",
                  },
                  {
                    feature: "Data Privacy",
                    generic: "Data used for training",
                    draftmate: "Encrypted & Private Vault",
                  },
                  {
                    feature: "Legal Tone Customization",
                    generic: "Generic, robotic tone",
                    draftmate: "Learns Your Style",
                  },
                ].map((row, idx) => (
                  <tr key={idx}>
                    <td className="py-4 px-6 text-[#111318] font-medium">
                      {row.feature}
                    </td>
      ...
      <section className="py-20 px-4 lg:px-40 bg-background-light dark:bg-background-dark">
        <div className="layout-content-container flex flex-col max-w-[960px] mx-auto gap-12 items-center">
          <div className="flex flex-col gap-4 text-center">
            ...
            <p className="text-[#616f89] text-lg max-w-[600px] mx-auto">
              Watch how easy it is to draft a petition in under 5 minutes.
            </p>
          </div>
      ...
      <section className="py-20 px-4 lg:px-40 bg-white">
        <div className="layout-content-container flex flex-col max-w-[960px] mx-auto gap-12">
          <h2 className="text-[#111318] text-3xl font-black leading-tight text-center lg:text-4xl">
            From Facts to Filing in 4 Steps
          </h2>
          <div className="relative flex flex-col md:flex-row justify-between items-start w-full gap-8 md:gap-4">
            ...
            <div className="flex md:flex-col items-center md:items-start gap-6 md:gap-4 flex-1">
              <div className="size-12 rounded-full bg-primary text-white flex items-center justify-center text-lg font-bold shadow-lg shadow-primary/30 shrink-0">
                1
              </div>
              <div className="bg-white md:bg-transparent pr-4 md:pr-0">
                ...
                <p className="text-[#616f89] text-sm mt-1">
                  Input raw details, upload voice notes, or paste client emails.
                </p>
              </div>
            </div>
            <div className="flex md:flex-col items-center md:items-start gap-6 md:gap-4 flex-1">
              <div className="size-12 rounded-full bg-white border-2 border-primary text-primary flex items-center justify-center text-lg font-bold shrink-0">
                2
              </div>
              <div className="bg-white md:bg-transparent pr-4 md:pr-0">
                <h4 className="text-[#111318] text-lg font-bold">
                ...
                <p className="text-[#616f89] text-sm mt-1">
                  DraftMate finds relevant acts, sections, and precedents.
                </p>
              </div>
            </div>
            <div className="flex md:flex-col items-center md:items-start gap-6 md:gap-4 flex-1">
              <div className="size-12 rounded-full bg-white border-2 border-[#dbdfe6] text-[#616f89] flex items-center justify-center text-lg font-bold shrink-0">
                3
              </div>
              <div className="bg-white md:bg-transparent pr-4 md:pr-0">
                <h4 className="text-[#111318] text-lg font-bold">
                ...
                <p className="text-[#616f89] text-sm mt-1">
                  Get a comprehensive first draft in proper court format.
                </p>
              </div>
            </div>
            <div className="flex md:flex-col items-center md:items-start gap-6 md:gap-4 flex-1">
              ...
              <div className="bg-white md:bg-transparent pr-4 md:pr-0">
                ...
                <p className="text-[#616f89] text-sm mt-1">
                  Fine-tune the content, export to Word/PDF, and file.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 lg:px-40 bg-background-light dark:bg-background-dark">
        <div className="layout-content-container flex flex-col max-w-[960px] mx-auto gap-12">
          <div className="flex flex-col gap-4 text-center">
            <h2 className="text-[#111318] text-3xl font-black leading-tight lg:text-4xl">
              Not Just AI. Your Digital Junior Advocate.
            </h2>
          </div>
              ...
              <ul className="flex flex-col gap-4">
                <li className="flex gap-3 text-[#111318]">
                  ...
                  <span className="font-medium">
                    Instant research with relevant citations.
                  </span>
                </li>
                <li className="flex gap-3 text-[#111318]">
                  <span className="material-symbols-outlined text-green-500">
                  ...
                  <span className="font-medium">
                    Auto-formatted templates for every court.
                  </span>
                </li>
                <li className="flex gap-3 text-[#111318]">
                  <span className="material-symbols-outlined text-green-500">
                  ...
                  <span className="font-medium">
                    Always updated with latest laws.
                  </span>
                </li>
              </ul>
            </div>
      ...
      <section className="py-20 px-4 lg:px-40 bg-white">
        <div className="layout-content-container flex flex-col lg:flex-row items-center max-w-[960px] mx-auto gap-12">
          <div className="flex-1 flex flex-col gap-6">
            ...
            <h2 className="text-[#111318] text-3xl font-black leading-tight lg:text-4xl">
              Showcase Your Expertise with a Digital Profile
            </h2>
            <p className="text-[#616f89] text-lg">
              Every DraftMate subscription includes a premium public profile.
              Share your digital visiting card, highlight your areas of
              practice, and let clients discover you easily.
            </p>
          ...
          <div className="flex-1 w-full flex justify-center lg:justify-end">
            <div className="w-full max-w-[360px] bg-white rounded-2xl shadow-xl overflow-hidden border border-[#f0f2f4] hover:shadow-2xl transition-shadow duration-500">
              ...
              <div className="px-6 pb-6 -mt-12 flex flex-col items-center text-center">
                <div
                  className="size-24 rounded-full border-4 border-white bg-gray-200 overflow-hidden"
                  data-alt="Portrait of an Indian Advocate in professional attire"
                >
                  <img
                    alt="Advocate Portrait"
                    className="w-full h-full object-cover"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDingvAZZEdxxo8SsCLy-QfkJsniZjVY1Xv1VCZtLpC8yFGsKg4BMKDU6p-GLrPQ0djboAgRIZIInLcWC7vmUmKL9Q_vn5MBVj3h1lWhGSj-D_nNRoa3YTHZ_uuRDMnVsQyJGtYPrDerOi4VW5nRAr2CIio6UQRmoPZcINhqIotGqtux6Gi8A22K98MzwIdnZzs4kxVwMHp1hfR8TjoOusPr0PFuM1X9UwCKLk6ePqSFw8whhDJwb36IK9xuHsJGJWe8PxZZ-OBAkg9"
                  />
                </div>
                ...
                <p className="text-sm text-[#616f89]">
                  Supreme Court of India • 15 Years Exp.
                </p>
      ...
      <section
        id="testimonials"
        className="py-20 bg-background-light dark:bg-background-dark border-t border-[#f0f2f4] overflow-hidden"
      >
        <div className="flex flex-col gap-12">
          <div className="layout-content-container flex flex-col max-w-[960px] mx-auto gap-4 text-center px-4 lg:px-40">
            ...
            <p className="text-[#616f89] text-lg max-w-[600px] mx-auto">
              See how DraftMate is transforming legal practices from District
          ...
          <div className="w-full relative mask-linear-fade">
            <div className="animate-scroll flex w-max hover:pause pl-4">
              {[...testimonials, ...testimonials].map((testimonial, idx) => (
                <div
                  key={idx}
                  className="flex flex-row bg-white rounded-xl border border-[#f0f2f4] shadow-sm w-[400px] h-[280px] mr-6 overflow-hidden group hover:shadow-md transition-all duration-300"
                >
                  <div className="flex-1 p-5 flex flex-col relative">
                    ...
                    <div className="flex-1 flex items-center">
                      <p className="text-[#111318] text-sm leading-relaxed italic text-left line-clamp-[8]">
                        "{testimonial.text}"
                      </p>
                    </div>
                  </div>
      ...
      <section className="py-20 px-4 lg:px-40 bg-white border-t border-[#f0f2f4]">
        <div className="layout-content-container flex flex-col max-w-7xl mx-auto gap-8 items-center">
          <h3 className="text-[#616f89] text-sm font-bold uppercase tracking-wider text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 lg:gap-12 opacity-60">
            <img
              src={LawJuristLogo}
              alt="Law Jurist"
              className="h-12 w-auto grayscale hover:grayscale-0 transition-all cursor-pointer object-contain"
            />
            <img
              src={ChristUniversityLogo}
              alt="Christ University"
              className="h-16 w-auto grayscale hover:grayscale-0 transition-all cursor-pointer object-contain"
            />
            <img
              src={ImsUnisonLogo}
              alt="IMS Unison University"
              className="h-16 w-auto grayscale hover:grayscale-0 transition-all cursor-pointer object-contain"
            />
            <img
              src={KesjpLawCollegeLogo}
              alt="KES' Shri Jayantilal H. Patel Law College"
              className="h-16 w-auto grayscale hover:grayscale-0 transition-all cursor-pointer object-contain"
            />
            <img
              src={LegalVidyaLogo}
        ...
        <div className="layout-content-container flex flex-col max-w-[1200px] mx-auto gap-16 relative z-10">
          <div className="flex flex-col gap-4 text-center items-center">
            ...
            <p className="text-gray-400 text-lg max-w-[600px]">
              We are constantly innovating. Here's what's coming next to
              DraftMate to make your practice even more powerful.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="group relative p-1 rounded-2xl bg-gradient-to-b from-white/10 to-white/5 hover:from-primary/50 hover:to-purple-600/50 transition-all duration-300">
              ...
              <div className="relative z-10 p-6 flex flex-col h-full gap-4">
                <div className="flex justify-between items-start">
                  ...
                  <span className="px-2 py-1 rounded text-[10px] font-bold bg-white/10 text-gray-300 uppercase tracking-wider border border-white/5">
                    Coming Soon
                  </span>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">
                    Advocate Profile & Digital Presence
                  </h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Premium subscribers get a personalized SEO-optimized profile
                    page. Showcase your expertise, areas of practice, and
                    contact details like a digital visiting card.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative p-1 rounded-2xl bg-gradient-to-b from-white/10 to-white/5 hover:from-primary/50 hover:to-purple-600/50 transition-all duration-300">
              ...
              <div className="relative z-10 p-6 flex flex-col h-full gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Securely share live drafts with colleagues or clients for
                    review. Collaborate vertically with ease and maintain
            ...
            <div className="group relative p-1 rounded-2xl bg-gradient-to-b from-white/10 to-white/5 hover:from-primary/50 hover:to-purple-600/50 transition-all duration-300">
              ...
              <div className="relative z-10 p-6 flex flex-col h-full gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">
                    AI Voice Agent (Judge Mode)
                  </h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Practice your arguments with an AI that simulates a Judge.
                    It listens to your voice arguments and counters with legal
                    queries to help you prepare.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative p-1 rounded-2xl bg-gradient-to-b from-white/10 to-white/5 hover:from-primary/50 hover:to-purple-600/50 transition-all duration-300">
              ...
              <div className="relative z-10 p-6 flex flex-col h-full gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Direct access to E-Courts services. Track case status, next
                    hearing dates, and orders for all your running cases in one
                    dashboard.
                  </p>
                </div>
              </div>
            ...
            <div className="group relative p-1 rounded-2xl bg-gradient-to-b from-white/10 to-white/5 hover:from-primary/50 hover:to-purple-600/50 transition-all duration-300">
              ...
              <div className="relative z-10 p-6 flex flex-col h-full gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Draft in English and instantly translate to Hindi, Marathi,
                    Tamil, and other regional languages for district court
                    filings.
                  </p>
                </div>
              </div>
            ...
            <div className="group relative p-1 rounded-2xl bg-gradient-to-b from-white/10 to-white/5 hover:from-primary/50 hover:to-purple-600/50 transition-all duration-300">
              ...
              <div className="relative z-10 p-6 flex flex-col h-full gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    A centralized repository of verified court templates, bare
                    acts, and legal maxims available at your fingertips while
                    drafting.
                  </p>
                </div>
              </div>
      ...
      <section className="py-20 px-4 bg-background-light dark:bg-background-dark border-t border-[#f0f2f4]">
        <div className="max-w-[800px] mx-auto">
          <div className="flex flex-col gap-4 text-center mb-12">
            ...
            <p className="text-[#616f89] text-lg">
              Find answers to common questions about DraftMate.
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            {faqs.map((faq, index) => (
              <details
                key={index}
                className="group border border-[#f0f2f4] bg-white rounded-xl shadow-sm overflow-hidden"
              >
                <summary className="flex items-center justify-between p-5 md:p-6 cursor-pointer hover:bg-slate-50 transition-colors list-none">
                  <span className="text-base md:text-lg font-bold text-[#111318] pr-4">
                    {faq.question}
                  </span>
                  <span className="material-symbols-outlined text-[#616f89] transition-transform duration-200 group-open:rotate-180">
                    expand_more
                  </span>
                </summary>
      ...
      <section className="py-24 px-4 bg-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-[800px] mx-auto gap-8">
          <h2 className="text-white text-4xl lg:text-5xl font-black leading-tight tracking-tight">
            Upgrade Your Legal Practice Today
          </h2>
          <p className="text-blue-100 text-lg lg:text-xl max-w-[600px]">
            Join thousands of Indian advocates who are drafting faster,
            researching smarter, and winning more cases.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <Link
              to="/login"
              className="flex min-w-[200px] cursor-pointer items-center justify-center rounded-lg h-14 px-8 bg-white text-primary text-lg font-bold hover:bg-blue-50 transition-colors shadow-xl"
            >
              Get Started Now
            </Link>
          ...
          <p className="text-blue-200 text-xs mt-4">
            No credit card required for trial. 100% Secure & Confidential.
          </p>
        </div>
      </section>
            ...
            <div className="flex flex-col gap-4 max-w-xs">
              ...
              <div className="flex flex-col gap-2 text-sm text-gray-400">
                ...
                <p className="flex items-center gap-2 mt-2">
                  <span className="font-bold text-gray-500">CIN:</span>{" "}
                  U62090BR2026PTC082255
                </p>
                <p className="flex items-center gap-2">
                  <span className="font-bold text-gray-500">PAN:</span>{" "}
                  AAMCD4217D
                </p>
              </div>
              ...
              <div className="flex gap-4 my-2">
                ...
                <a
                  href="https://www.linkedin.com/company/draftmate-in/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                >
                ...
                <a
                  href="https://www.facebook.com/profile.php?id=61584223401695"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                >
                ...
                <a
                  href="https://www.instagram.com/draftmate.in/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                >
                ...
                <a
                  href="https://www.youtube.com/watch?v=E41ONA1AmBw"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                >
              ...
              <div className="flex flex-col gap-1 mt-4">
                ...
                <img
                  ...
                  className="h-10 w-fit object-contain opacity-80 hover:opacity-100 transition-opacity"
                />
              </div>
            </div>
